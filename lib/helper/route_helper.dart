import 'dart:convert';
import 'package:zaika/common/widgets/image_viewer_screen_widget.dart';
import 'package:zaika/common/widgets/not_found_widget.dart';
...
import 'package:zaika/features/business/screens/subscription_payment_screen.dart';
import 'package:zaika/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:zaika/features/cart/screens/cart_screen.dart';
import 'package:zaika/features/checkout/domain/models/place_order_body_model.dart';
import 'package:zaika/features/checkout/domain/models/pricing_view_model.dart';
import 'package:zaika/features/checkout/screens/checkout_screen.dart';
import 'package:zaika/features/checkout/screens/offline_payment_screen.dart';
import 'package:zaika/features/checkout/screens/order_successful_screen.dart';
import 'package:zaika/features/checkout/screens/payment_screen.dart';
import 'package:zaika/features/checkout/screens/payment_webview_screen.dart';
import 'package:zaika/features/dine_in/screens/dine_in_restaurant_screen.dart';
import 'package:zaika/features/favourite/screens/favourite_screen.dart';
import 'package:zaika/features/home/screens/map_view_screen.dart';
import 'package:zaika/features/html/enums/html_type.dart';
import 'package:zaika/features/html/screens/html_viewer_screen.dart';
import 'package:zaika/features/language/screens/language_screen.dart';
import 'package:zaika/features/location/screens/access_location_screen.dart';
import 'package:zaika/features/location/screens/map_screen.dart';
import 'package:zaika/features/location/screens/pick_map_screen.dart';
import 'package:zaika/features/notification/domain/models/notification_body_model.dart';
import 'package:zaika/features/notification/screens/notification_screen.dart';
import 'package:zaika/features/onboard/screens/onboarding_screen.dart';
import 'package:zaika/features/order/screens/guest_track_order_screen.dart';
import 'package:zaika/features/order/screens/order_details_screen.dart';
import 'package:zaika/features/order/screens/order_screen.dart';
import 'package:zaika/features/order/screens/order_tracking_screen.dart';
import 'package:zaika/features/order/screens/refund_request_screen.dart';
import 'package:zaika/features/profile/domain/models/update_user_model.dart';
import 'package:zaika/features/profile/screens/profile_screen.dart';
import 'package:zaika/features/profile/screens/update_profile_screen.dart';
import 'package:zaika/features/refer%20and%20earn/screens/refer_and_earn_screen.dart';
import 'package:zaika/features/restaurant/screens/all_restaurant_screen.dart';
import 'package:zaika/features/restaurant/screens/campaign_screen.dart';
import 'package:zaika/features/restaurant/screens/restaurant_product_search_screen.dart';
import 'package:zaika/features/restaurant/screens/restaurant_screen.dart';
import 'package:zaika/features/review/domain/models/rate_review_model.dart';
import 'package:zaika/features/review/screens/rate_review_screen.dart';
import 'package:zaika/features/review/screens/review_screen.dart';
import 'package:zaika/features/search/screens/search_screen.dart';
...
import 'package:zaika/features/address/screens/add_address_screen.dart';
import 'package:zaika/features/address/screens/address_screen.dart';
import 'package:zaika/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:zaika/features/auth/screens/restaurant_registration_screen.dart';
import 'package:zaika/features/auth/screens/sign_in_screen.dart';
import 'package:zaika/features/auth/screens/sign_up_screen.dart';
import 'package:zaika/features/category/screens/category_product_screen.dart';
import 'package:zaika/features/category/screens/category_screen.dart';
import 'package:zaika/features/chat/domain/models/conversation_model.dart';
import 'package:zaika/features/chat/screens/chat_screen.dart';
import 'package:zaika/features/chat/screens/conversation_screen.dart';
import 'package:zaika/features/coupon/screens/coupon_screen.dart';
import 'package:zaika/features/cuisine/screens/cuisine_restaurant_screen.dart';
import 'package:zaika/features/cuisine/screens/cuisine_screen.dart';
import 'package:zaika/features/dashboard/screens/dashboard_screen.dart';
import 'package:zaika/features/interest/screens/interest_screen.dart';
import 'package:zaika/features/loyalty/screens/loyalty_screen.dart';
import 'package:zaika/features/product/screens/item_campaign_screen.dart';
import 'package:zaika/features/product/screens/popular_food_screen.dart';
import 'package:zaika/features/splash/domain/models/deep_link_body.dart';
import 'package:zaika/features/splash/screens/splash_screen.dart';
import 'package:zaika/features/support/screens/support_screen.dart';
import 'package:zaika/features/update/screens/update_screen.dart';
...
import 'package:zaika/features/wallet/screens/wallet_screen.dart';
...
import '../features/splash/screens/advertisement_screen.dart';
...
class RouteHelper {
  ...
  static const String advertisement = '/advertisement-screen';

  static String getAdVideoRoute() => advertisement;
  ...
  static String getMapRoute(AddressModel addressModel, String page,
      {String? restaurantName, Restaurant? restaurant, bool? isDineOrder}) {
  ...
  static String getOrderSuccessRoute(
          String orderID, String status, double? amount, String? contactNumber,
          {bool? isDeliveryOrder}) =>
      '$orderSuccess?id=$orderID&status=$status&amount=$amount&contact_number=$contactNumber&is_delivery_order=$isDeliveryOrder';
  ...
  static String getCheckoutRoute(String page, {bool fromDineIn = false}) =>
      '$checkout?page=$page&from_dine_in=$fromDineIn';
  ...
  static String getReviewRoute(RateReviewModel rateReviewModel) {
    String data =
        base64Encode(utf8.encode(jsonEncode(rateReviewModel.toJson())));
    return '$rateReview?data=$data';
  }

  static String getUpdateRoute(bool isUpdate) =>
      '$update?update=${isUpdate.toString()}';
  static String getCartRoute(
          {bool fromReorder = false, bool fromDineIn = false}) =>
      '$cart?from_reorder=$fromReorder&from_dine_in=$fromDineIn';
  ...
  static String getRestaurantReviewRoute(
      int? restaurantID, String? restaurantName, Restaurant restaurant) {
    String data =
        base64Url.encode(utf8.encode(jsonEncode(restaurant.toJson())));
  ...
  static String getWalletRoute(
          ...
          bool? fromMenuPage,
          bool fromNotification = false}) =>
      '$wallet?payment_status=$fundStatus&from_menu_page=$fromMenuPage&from_notification=$fromNotification';
  ...
  static String getMapViewRoute({bool? fromDineInScreen}) =>
      '$mapView?from_dine_in_screen=${fromDineInScreen.toString()}';
  ...
  static String getSubscriptionSuccessRoute(
          {String? status,
          required bool fromSubscription,
          int? restaurantId,
          int? packageId}) =>
      '$subscriptionSuccess?flag=$status&from_subscription=$fromSubscription&restaurant_id=$restaurantId&package_id=$packageId';
  static String getSubscriptionPaymentRoute(
          {required int? restaurantId, required int? packageId}) =>
      '$subscriptionPayment?restaurant-id=$restaurantId&package-id=$packageId';
  ...
  static List<GetPage> routes = [
    GetPage(
        name: advertisement, page: () => getRoute(const AdvertisementScreen())),
    GetPage(
        name: initial,
    ...
    GetPage(
        ...
        page: () {
          ...
          if (Get.parameters['user_model'] != null &&
            ...
            List<int> decode = base64Decode(Get.parameters['user_model'] != null
                ? Get.parameters['user_model']!.replaceAll(' ', '+')
                : '');
            userModel =
                UpdateUserModel.fromJson(jsonDecode(utf8.decode(decode)));
          }
        ...
        page: () {
          ...
          return (fromAddress && pickMapScreen == null)
              ...
              : (pickMapScreen ??
                  PickMapScreen(
                    fromSignUp: Get.parameters['page'] == signUp,
                    fromSplash: Get.parameters['page'] == splash,
    ...
    GetPage(
        ...
        page: () {
          ...
          if (Get.parameters['restaurant'] != null &&
              Get.parameters['restaurant'] != 'null') {
            List<int> decode = base64Decode(Get.parameters['restaurant'] != null
                ? Get.parameters['restaurant']!.replaceAll(' ', '+')
                : '');
          ...
          return getRoute(MapScreen(
            ...
            fromOrder: Get.parameters['page'] == 'order',
            restaurant: restaurant,
    ...
    GetPage(
        ...
        page: () {
          ...
          int? restaurantId = (Get.parameters['restaurant_id'] != null &&
              ...
              : null;
          int? packageId = (Get.parameters['package_id'] != null &&
          ...
          return getRoute(checkoutScreen ??
              (!fromCart
                  ...
                  : CheckoutScreen(
                      ...
                      fromDineInPage: Get.parameters['from_dine_in'] == 'true',
                    )));
        }),
    GetPage(
        name: orderTracking,
    ...
    GetPage(
        name: support,
        page: () => getRoute(byPuss: true, const SupportScreen())),
    GetPage(
        name: update,
    ...
    GetPage(
        name: rateReview,
        page: () {
          RateReviewModel data = RateReviewModel.fromJson(jsonDecode(
              utf8.decode(
                  base64Decode(Get.parameters['data']!.replaceAll(' ', '+')))));
    ...
    GetPage(
        ...
        page: () => getRoute(ReviewScreen(
            ...
            restaurantName: Get.parameters['restaurantName'],
            restaurant: Restaurant.fromJson(jsonDecode(utf8.decode(
                base64Url.decode(
                    Get.parameters['restaurant']!.replaceAll(' ', '+')))))))),
    GetPage(
        name: allRestaurants,
    ...
    GetPage(
        ...
        page: () {
          return getRoute(WalletScreen(
              ...
              fromMenuPage: Get.parameters['from_menu_page'] == 'true',
              fromNotification: Get.parameters['from_notification'] == 'true'));
        }),
    ...
    GetPage(
        name: mapView,
        page: () => getRoute(MapViewScreen(
            fromDineInScreen:
                Get.parameters['from_dine_in_screen'] == 'true'))),
    GetPage(
    ...
    GetPage(
        ...
        page: () => getRoute(SubscriptionSuccessOrFailedScreen(
              ...
              restaurantId: (Get.parameters['restaurant_id'] != null &&
                  ...
                  ? int.parse(Get.parameters['restaurant_id']!)
                  : null,
              packageId: (Get.parameters['package_id'] != null &&
                      Get.parameters['package_id'] != 'null')
                  ? int.parse(Get.parameters['package_id']!)
                  : null,
            ))),
    GetPage(
        ...
        page: () => SubscriptionPaymentScreen(
            restaurantId: int.parse(Get.parameters['restaurant-id']!),
