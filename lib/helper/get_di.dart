...
import 'package:zaika/features/dashboard/domain/repositories/dashboard_repo.dart';
...
import 'package:zaika/features/dine_in/domain/repositories/dine_in_repository.dart';
import 'package:zaika/features/dine_in/domain/repositories/dine_in_repository_interface.dart';
import 'package:zaika/features/dine_in/domain/services/dine_in_service.dart';
...
import 'package:zaika/features/home/domain/repositories/advertisement_repository.dart';
import 'package:zaika/features/home/domain/repositories/advertisement_repository_interface.dart';
import 'package:zaika/features/home/domain/services/advertisement_service.dart';
...
import 'package:zaika/features/cart/domain/repositories/cart_repository.dart';
import 'package:zaika/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:zaika/features/cart/domain/services/cart_service.dart';
import 'package:zaika/features/cart/domain/services/cart_service_interface.dart';
import 'package:zaika/features/chat/controllers/chat_controller.dart';
import 'package:zaika/features/chat/domain/repositories/chat_repository.dart';
import 'package:zaika/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:zaika/features/chat/domain/services/chat_service.dart';
...
import 'package:zaika/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:zaika/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:zaika/features/checkout/domain/services/checkout_service.dart';
import 'package:zaika/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:zaika/features/coupon/controllers/coupon_controller.dart';
import 'package:zaika/features/home/controllers/home_controller.dart';
import 'package:zaika/features/home/domain/repositories/home_repository.dart';
import 'package:zaika/features/home/domain/repositories/home_repository_interface.dart';
import 'package:zaika/features/home/domain/services/home_service.dart';
...
import 'package:zaika/features/order/domain/repositories/order_repository.dart';
import 'package:zaika/features/order/domain/repositories/order_repository_interface.dart';
import 'package:zaika/features/order/domain/services/order_service.dart';
import 'package:zaika/features/order/domain/services/order_service_interface.dart';
import 'package:zaika/features/product/domain/repositories/campaign_repository.dart';
...
import 'package:zaika/features/html/domain/repositories/html_repository_interface.dart';
import 'package:zaika/features/html/domain/services/html_service.dart';
import 'package:zaika/features/html/domain/services/html_service_interface.dart';
import 'package:zaika/features/language/domain/models/language_model.dart';
import 'package:zaika/features/language/domain/repository/language_repository.dart';
import 'package:zaika/features/language/domain/repository/language_repository_interface.dart';
import 'package:zaika/features/language/domain/service/language_service.dart';
import 'package:zaika/features/language/domain/service/language_service_interface.dart';
import 'package:zaika/features/notification/controllers/notification_controller.dart';
import 'package:zaika/features/notification/domain/repository/notification_repository.dart';
import 'package:zaika/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:zaika/features/notification/domain/service/notification_service.dart';
import 'package:zaika/features/notification/domain/service/notification_service_interface.dart';
import 'package:zaika/features/onboard/controllers/onboard_controller.dart';
import 'package:zaika/features/onboard/domain/repository/onboard_repository.dart';
import 'package:zaika/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:zaika/features/onboard/domain/service/notification_service.dart';
import 'package:zaika/features/onboard/domain/service/onboard_service_interface.dart';
import 'package:zaika/features/profile/controllers/profile_controller.dart';
import 'package:zaika/features/profile/domain/repositories/profile_repository.dart';
import 'package:zaika/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:zaika/features/profile/domain/services/profile_service.dart';
...
import 'package:zaika/features/restaurant/domain/services/restaurant_service.dart';
...
import 'package:zaika/features/search/domain/repositories/search_repository.dart';
import 'package:zaika/features/search/domain/repositories/search_repository_interface.dart';
import 'package:zaika/features/search/domain/services/search_service.dart';
...
import 'package:zaika/features/address/domain/reposotories/address_repo.dart';
import 'package:zaika/features/address/domain/reposotories/address_repo_interface.dart';
import 'package:zaika/features/address/domain/services/address_service.dart';
...
import 'package:zaika/features/auth/domain/reposotories/auth_repo.dart';
import 'package:zaika/features/auth/domain/reposotories/auth_repo_interface.dart';
import 'package:zaika/features/auth/domain/reposotories/deliveryman_registration_repo.dart';
import 'package:zaika/features/auth/domain/reposotories/deliveryman_registration_repo_interface.dart';
import 'package:zaika/features/auth/domain/reposotories/restaurant_registration_repo.dart';
import 'package:zaika/features/auth/domain/reposotories/restaurant_registration_repo_interface.dart';
import 'package:zaika/features/auth/domain/services/auth_service.dart';
import 'package:zaika/features/auth/domain/services/auth_service_interface.dart';
import 'package:zaika/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:zaika/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:zaika/features/auth/domain/services/restaurant_registration_service.dart';
import 'package:zaika/features/auth/domain/services/restaurant_registration_service_interface.dart';
import 'package:zaika/features/business/controllers/business_controller.dart';
import 'package:zaika/features/business/domain/reposotories/business_repo.dart';
import 'package:zaika/features/business/domain/reposotories/business_repo_interface.dart';
import 'package:zaika/features/business/domain/services/business_service.dart';
import 'package:zaika/features/business/domain/services/business_service_interface.dart';
import 'package:zaika/features/category/controllers/category_controller.dart';
import 'package:zaika/features/category/domain/reposotories/category_repository.dart';
import 'package:zaika/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:zaika/features/category/domain/services/category_service.dart';
import 'package:zaika/features/category/domain/services/category_service_interface.dart';
import 'package:zaika/features/coupon/domain/reposotories/coupon_repository.dart';
import 'package:zaika/features/coupon/domain/reposotories/coupon_repository_interface.dart';
import 'package:zaika/features/coupon/domain/services/coupon_service.dart';
import 'package:zaika/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:zaika/features/cuisine/controllers/cuisine_controller.dart';
import 'package:zaika/features/cuisine/domain/repositories/cuisine_repository.dart';
import 'package:zaika/features/cuisine/domain/repositories/cuisine_repository_interface.dart';
import 'package:zaika/features/cuisine/domain/services/cuisine_service.dart';
...
import 'package:zaika/features/dashboard/domain/services/dashboard_service.dart';
...
import 'package:zaika/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:zaika/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:zaika/features/favourite/domain/services/favourite_service.dart';
import 'package:zaika/features/favourite/domain/services/favourite_service_interface.dart';
import 'package:zaika/features/interest/controllers/interest_controller.dart';
import 'package:zaika/features/interest/domain/repositories/interest_repository.dart';
import 'package:zaika/features/interest/domain/repositories/interest_repository_interface.dart';
import 'package:zaika/features/interest/domain/services/interest_service.dart';
import 'package:zaika/features/interest/domain/services/interest_service_interface.dart';
import 'package:zaika/features/location/controllers/location_controller.dart';
import 'package:zaika/features/location/domain/reposotories/location_repo.dart';
import 'package:zaika/features/location/domain/reposotories/location_repo_interface.dart';
import 'package:zaika/features/location/domain/services/location_service.dart';
import 'package:zaika/features/location/domain/services/location_service_interface.dart';
import 'package:zaika/features/loyalty/controllers/loyalty_controller.dart';
import 'package:zaika/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:zaika/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:zaika/features/loyalty/domain/services/loyalty_service.dart';
import 'package:zaika/features/loyalty/domain/services/loyalty_service_interface.dart';
import 'package:zaika/features/product/controllers/product_controller.dart';
import 'package:zaika/features/product/domain/repositories/product_repository.dart';
import 'package:zaika/features/product/domain/repositories/product_repository_interface.dart';
import 'package:zaika/features/product/domain/services/product_service.dart';
import 'package:zaika/features/product/domain/services/product_service_interface.dart';
import 'package:zaika/features/review/controllers/review_controller.dart';
import 'package:zaika/features/review/domain/repositories/review_repository.dart';
import 'package:zaika/features/review/domain/repositories/review_repository_interface.dart';
import 'package:zaika/features/review/domain/services/review_service.dart';
import 'package:zaika/features/review/domain/services/review_service_interface.dart';
import 'package:zaika/features/splash/domain/repositories/splash_repository.dart';
import 'package:zaika/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:zaika/features/splash/domain/services/splash_service.dart';
...
import 'package:zaika/features/verification/domein/reposotories/verification_repo.dart';
import 'package:zaika/features/verification/domein/reposotories/verification_repo_interface.dart';
import 'package:zaika/features/verification/domein/services/verification_service.dart';
import 'package:zaika/features/verification/domein/services/verification_service_interface.dart';
import 'package:zaika/features/wallet/controllers/wallet_controller.dart';
import 'package:zaika/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:zaika/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:zaika/features/wallet/domain/services/wallet_service.dart';
import 'package:zaika/features/wallet/domain/services/wallet_service_interface.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  DineInRepositoryInterface dineInRepositoryInterface =
      DineInRepository(apiClient: Get.find());
  Get.lazyPut(() => dineInRepositoryInterface);
  DineInServiceInterface dineInServiceInterface =
      DineInService(dineInRepositoryInterface: Get.find());
  Get.lazyPut(() => dineInServiceInterface);
  EarnReferRepositoryInterface earnReferRepositoryInterface =
      EarnReferRepository(apiClient: Get.find());
  Get.lazyPut(() => earnReferRepositoryInterface);
  EarnReferServiceInterface earnReferServiceInterface =
      EarnReferService(earnReferRepositoryInterface: Get.find());
  ...
  Get.lazyPut(
      () => ReferAndEarnController(earnReferServiceInterface: Get.find()));
