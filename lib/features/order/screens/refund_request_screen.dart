  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        return Center(
          child: (orderController.refundReasons != null &&
                  orderController.refundReasons!.isNotEmpty)
              ? Container(
                        ...
                        Expanded(
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('what_is_wrong_with_this_order'.tr,
                                  ...
                                  Container(
                                    ...
                                    child: DropdownButton<String>(
                                      value: orderController.refundReasons![
                                          orderController.selectedReasonIndex],
                                      items: orderController.refundReasons!
                                          .map((String? items) {
                                      ...
                                      onChanged: (value) {
                                        orderController.selectReason(
                                            orderController.refundReasons!
                                                .indexOf(value));
                                        if (_noteController.text.isNotEmpty) {
                                          _noteController.text = '';
                                        }
                                        if (orderController.refundImage !=
                                            null) {
                                  ...
                                  orderController.selectedReasonIndex != 0
                                      ? Column(
                                          crossAxisAlignment:
