                ...
                !isDesktop
                    ? Padding(
                        padding: const EdgeInsets.symmetric(
                            horizontal: Dimensions.paddingSizeLarge,
                            vertical: Dimensions.paddingSizeSmall),
                        child: Text('delivery_man_details'.tr,
                            style: robotoMedium),
                      )
                    : const SizedBox(),
                Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        order.deliveryMan!.restaurantId != null
                            ? Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(
                                      Dimensions.radiusSmall),
                                ...
                                child: Text(
                                  'this_delivery_man_is_restaurant_delivery_man'
                                      .tr,
                                  style: robotoRegular.copyWith(
                                      fontSize: Dimensions.fontSizeSmall),
                                ),
                            ...
                            ? Text(
                                orderController.trackModel!.offlinePayment !=
                                    ...
                                    ? orderController.trackModel!
                                        .offlinePayment!.data!.status!.tr
                                    : '',
                                style: robotoMedium.copyWith(
                                    color: (orderController.trackModel!
                                                    .offlinePayment !=
                                                null
                                            ? orderController
                                                    .trackModel!
