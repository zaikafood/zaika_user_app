...
import 'banner_view_widget.dart';
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                    'see_our_most_popular_restaurant_and_foods'
                                        .tr,
        ...
        onTap: () {
          Get.toNamed(
            ...
            arguments: RestaurantScreen(
                restaurant: Restaurant(id: advertisement.restaurantId)),
          );
        },
                            ...
                            children: [
                              ...
                              GetBuilder<FavouriteController>(
                                ...
                                bool isWished = favouriteController
                                    .wishRestIdList
                                    .contains(advertisement.restaurantId);
                            ...
                            onTap: () {
                              Get.toNamed(
                                RouteHelper.getRestaurantRoute(
                                    widget.advertisement.restaurantId),
                                arguments: RestaurantScreen(
                                    restaurant: Restaurant(
                                        id: widget.advertisement.restaurantId)),
                              );
                            },
                            child: Container(
      ...
      return advertisementController.advertisementList != null &&
          ...
          ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Row(
                ...
                children: advertisementController.advertisementList!
                    .map((advertisement) {
                  int index = advertisementController.advertisementList!
      ...
      child: Container(
        ...
        margin: EdgeInsets.only(
          top: ResponsiveHelper.isDesktop(context)
              ? Dimensions.paddingSizeLarge * 3.5
              : 0,
