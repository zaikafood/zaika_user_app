...
import 'package:zaika/features/address/domain/models/zone_model.dart';
...
class LocationRepo implements LocationRepoInterface {
  ...
  Future<String> getAddressFromGeocode(LatLng latLng) async {
    ...
    print("::::::::::url :${AppConstants.geocodeUri}?lat=${latLng.latitude}&lng=${latLng.longitude}::::::::::::::");
    String address = 'Unknown Location Found';
    print("::::::::response of getAddressFromGeocode:::::::::::::${response.body}::");
    if(response.statusCode == 200 && response.body['status'] == 'OK') {
      address = response.body['results'][0]['formatted_address'].toString();
      print(":::::address :: $address:::::::");
    }else {
      print(":::::::getAddressFromGeocode:::::::${response.body['error_message'] ?? response.bodyString}::");
