...
import 'package:zaika/features/location/widgets/serach_location_widget.dart';
...
class _PickMapDialogState extends State<PickMapDialog> {
  ...
  void initState() {
    super.initState();
    print(":::::${Get.find<SplashController>().configModel!.defaultLocation!.lat}::::");
                    ...
                    ClipRRect(
                      ...
                      child: GoogleMap(
                        ...
                        minMaxZoomPreference: const MinMaxZoomPreference(0, 16),
                          ...
                          //   LatLngBounds(
                          //     southwest: LatLng(6.0, 68.0),
                          //     northeast: LatLng(37.0, 97.0),
                          //   ),
                          // ),
