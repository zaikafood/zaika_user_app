...
import 'package:zaika/helper/extensions.dart';
...
class DeliverymanAdditionalDataSectionWidget extends StatelessWidget {
  ...
  const DeliverymanAdditionalDataSectionWidget(
      {super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return deliverymanController.dataList!.isNotEmpty
        ? Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                bool showTextField = deliverymanController
                            .dataList![index].fieldType ==
                        'text' ||
                    deliverymanController.dataList![index].fieldType ==
                        'number' ||
                    deliverymanController.dataList![index].fieldType ==
                        'email' ||
                    deliverymanController.dataList![index].fieldType == 'phone';
                bool showDate =
                    deliverymanController.dataList![index].fieldType == 'date';
                bool showCheckBox =
                    deliverymanController.dataList![index].fieldType ==
                        'check_box';
                bool showFile =
                    deliverymanController.dataList![index].fieldType == 'file';
                return Padding(
                  padding: EdgeInsets.only(
                      bottom: isDesktop
                  ...
                  child: showTextField
                      ? CustomTextFieldWidget(
                          hintText: deliverymanController
                                  .dataList![index].placeholderData ??
                              '',
                          controller:
                              deliverymanController.additionalList![index],
                          inputType: deliverymanController
                                      .dataList![index].fieldType ==
                                  'number'
                              ...
                              : deliverymanController
                                  ...
                                  : deliverymanController
                                      ...
                                      : TextInputType.text,
                          isRequired: deliverymanController
                                  .dataList![index].isRequired ==
                              1,
                          capitalization: TextCapitalization.words,
                          labelText: deliverymanController
                                  .dataList![index].placeholderData ??
                              '',
                          required: deliverymanController
                                  .dataList![index].isRequired ==
                              1,
                          validator: deliverymanController
                                      .dataList![index].isRequired ==
                                  1
                              ? (value) =>
                                    ...
                                    if (pickedDate != null) {
                                      String formattedDate =
                                          DateConverter.dateTimeForCoupon(
                                              pickedDate);
                                      deliverymanController.setAdditionalDate(
                                          index, formattedDate);
                                    }
                                  },
                                  ...
                                  ? Column(
                                      ...
                                      children: [
                                          ...
                                          Builder(builder: (context) {
                                            FilePickerResult? file = 0 ==
                                                    deliverymanController
                                                        .additionalList![index]
                                                        .length
                                                ? null
                                                : deliverymanController
                                                    .additionalList![index][0];
                                            bool isImage = false;
                                            String fileName = '';
                                            if (file != null) {
                                                            ...
                                                            isImage &&
                                                                ...
                                                                : DottedBorder(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child: Row(
                                                                          children: [
                                                                            Image.asset(Images.documentIcon,
                                                                                height: 30,
                                                                                width: 30,
                                                                                fit: BoxFit.contain),
                                                          ...
                                                          child: Row(children: [
                                                            ...
                                                            Expanded(
                                                                child: Column(
                                                                    ...
                                                                    children: [
                                                                  Text(
                                                                    deliverymanController.dataList![index].mediaData!.uploadMultipleFiles ==
                                                                            1
                                                                  ...
                                                                  Text(
                                                                    'jpg_png_or_pdf_file_size_no_more_than_ten_mb'
                                                                        .tr,
                                                                  ...
                                                                  child: isImage &&
                                                                      ...
                                                                      : DottedBorder(
                                                                          ...
                                                                          child:
                                                                              Container(
                                                                            padding:
                                                                                const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: Dimensions.paddingSizeDefault),
                                                                            decoration:
                                                                                BoxDecoration(
