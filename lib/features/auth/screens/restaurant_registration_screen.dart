                    ...
                    ResponsiveHelper.isDesktop(context)
                        ...
                        : Padding(
                            ...
                            child: Column(
                                ...
                                children: [
                                  Text(
                                    restaurantRegController.storeStatus == 0.1
                        ...
                        child: FooterViewWidget(
                          child: SizedBox(
                            ...
                            child: ResponsiveHelper.isDesktop(context)
                                ? webView(restaurantRegController)
                                : Column(children: [
                                    Visibility(
                                      visible:
                                          restaurantRegController.storeStatus ==
                                              ...
                                              Container(
                                                ...
                                                child: Column(children: [
                                                  ...
                                                  CustomTextFieldWidget(
                                                    titleText:
                                                        'write_restaurant_name'
                                                            .tr,
                                                    errorText: ApiChecker
                                                        .errors['name'],
                                                    ...
                                                    validator: (value) =>
                                                        ValidateCheck
                                                            .validateEmptyText(
                                                                value,
                                                                "restaurant_name_field_is_required"
                                                                    .tr),
                                                  ),
                                                  const SizedBox(
                                                      height: Dimensions
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child: restaurantRegController.pickedLogo != null
                                                                                ? GetPlatform.isWeb
                                                                                    ? Image.network(
                                                                                        restaurantRegController.pickedLogo!.path,
                                                                                        width: 150,
                                                                                        height: 120,
                                                                                        fit: BoxFit.cover,
                                                                                      )
                                                                                    : Image.file(
                                                                                        File(restaurantRegController.pickedLogo!.path),
                                                                                        width: 150,
                                                                                        height: 120,
                                                                                        fit: BoxFit.cover,
                                                                                      )
                                                                        ...
                                                                        Positioned(
                                                                          ...
                                                                          child:
                                                                              InkWell(
                                                                            onTap: () =>
                                                                                restaurantRegController.pickImage(true, false),
                                                                            child:
                                                                                DottedBorder(
                                                                              options: RoundedRectDottedBorderOptions(color: Theme.of(context).primaryColor, strokeWidth: 1, strokeCap: StrokeCap.butt, dashPattern: const [5, 5], padding: const EdgeInsets.all(0), radius: Radius.circular(Dimensions.radiusDefault)),
                                                                              child: Center(
                                                                                child: Visibility(
                                                              ...
                                                              Stack(children: [
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: restaurantRegController.pickedCover !=
                                                                            null
                                                                        ? GetPlatform.isWeb
                                                                            ? Image.network(
                                                                                restaurantRegController.pickedCover!.path,
                                                                                width: context.width,
                                                                                height: 120,
                                                                                fit: BoxFit.cover,
                                                                              )
                                                                            : Image.file(
                                                                                File(restaurantRegController.pickedCover!.path),
                                                                                width: context.width,
                                                                                height: 120,
                                                                                fit: BoxFit.cover,
                                                                              )
                                                                ...
                                                                Positioned(
                                                                  ...
                                                                  child:
                                                                      InkWell(
                                                                    onTap: () =>
                                                                        restaurantRegController.pickImage(
                                                                            false,
                                                                            false),
                                                                    child:
                                                                        DottedBorder(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Visibility(
                                                                          visible:
                                                                              restaurantRegController.pickedCover != null,
                                                                          child:
                                                                              Container(
                                                                            padding:
                                                  ...
                                                  CustomTextFieldWidget(
                                                    ...
                                                    validator: (value) =>
                                                        ValidateCheck
                                                            .validateEmptyText(
                                                                value,
                                                                "restaurant_vat_tax_field_is_required"
                                                                    .tr),
                                                  ),
                                                  const SizedBox(
                                                      height: Dimensions
                                        ...
                                        child: Column(
                                            ...
                                            children: [
                                              Row(children: [
                                                ...
                                                CustomToolTip(
                                                  message:
                                                      'this_info_will_need_for_restaurant_app_and_panel_login'
                                                          .tr,
                                                  tooltipController:
                                                      tooltipController,
                                                  preferredDirection:
                                                    ...
                                                    ? SizedBox(
                                                        ...
                                                        child:
                                                            restaurantRegController
                                                                    ...
                                                                    .isNotEmpty
                                                                ? Swiper(
                                                                    itemCount: restaurantRegController
                                                                        .packageModel!
                                                                        .packages!
                                                                        .length,
                                                                    viewportFraction:
                                                                        restaurantRegController.packageModel!.packages!.length >
                                                                                1
                                                                            ? 0.7
                                                                            : 1,
                                                                    physics: restaurantRegController.packageModel!.packages!.length >
                                                                            1
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return PackageCardWidget(
                                                                        canSelect:
                                                                            restaurantRegController.activeSubscriptionIndex ==
                                                                                index,
    ...
    return Form(
      ...
      child: Center(
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          restaurantRegistrationController.storeStatus != 0.9
              ? Column(
                  children: [
                    Container(
                      decoration: BoxDecoration(
                    ...
                    Container(
                      ...
                      margin: const EdgeInsets.symmetric(
                          vertical: Dimensions.paddingSizeSmall),
                      child: Column(children: [
                        restaurantRegistrationController.dataList!.isNotEmpty
                            ? Row(children: [
                                const Icon(Icons.person),
                                const SizedBox(
                                    width: Dimensions.paddingSizeSmall),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
              ...
              child: CustomButtonWidget(
                ...
                onPressed: () {
                  if (restaurantRegistrationController.storeStatus == 0.9) {
                    ...
                    restaurantRegistrationController
                        .resetRestaurantRegistration();

                    restaurantRegistrationController
                        .setRestaurantAdditionalJoinUsPageData(isUpdate: true);
                  }
                },
                buttonText: restaurantRegistrationController.storeStatus == 0.9
                    ? 'back'.tr
                    : 'reset'.tr,
                isBold: false,
                fontSize: Dimensions.fontSizeSmall,
            ...
            SizedBox(
                width: (restaurantRegistrationController.storeStatus == 0.9) &&
                        (Get.find<SplashController>()
                                .configModel!
                                .commissionBusinessModel ==
                            0) &&
      ...
      return Column(
        children: [
          CustomButtonWidget(
            ...
            buttonText: restaurantRegiController.storeStatus == 0.1 &&
                    !ResponsiveHelper.isDesktop(context)
                ? 'next'.tr
                : 'submit'.tr,
            onPressed: (restaurantRegiController.storeStatus == 0.1 &&
                        !ResponsiveHelper.isDesktop(context) &&
                        !restaurantRegiController.inZone) ||
                    (ResponsiveHelper.isDesktop(context) &&
                        !restaurantRegiController.inZone)
                ? null
                : () {
                    ...
                    if (restaurantRegiController.storeStatus != 0.1 ||
                        ResponsiveHelper.isDesktop(context)) {
                      for (DataModel data
                          in restaurantRegiController.dataList!) {
                        ...
                        int index =
                            restaurantRegiController.dataList!.indexOf(data);
                        ...
                        if (isTextField) {
                          ...
                          if (restaurantRegiController
                                  .additionalList![index].text !=
                              '') {
                            additionalData.addAll({
                              data.inputData!: restaurantRegiController
                                  .additionalList![index].text
                            });
                          } else {
                            if (isRequired) {
                          ...
                          if (restaurantRegiController.additionalList![index] !=
                              null) {
                            additionalData.addAll({
                              data.inputData!: restaurantRegiController
                          ...
                          for (var e in restaurantRegiController
                              .additionalList![index]) {
                            if (e != 0) {
                              checkData.add(e);
                    ...
                    String phoneWithCountryCode = _countryDialCode != null
                    ...
                    if (restaurantRegiController.storeStatus == 0.1 ||
                        restaurantRegiController.storeStatus == 0.6) {
                      if (restaurantRegiController.storeStatus == 0.1 &&
                          !ResponsiveHelper.isDesktop(context)) {
                        if (_formKeyLogin!.currentState!.validate()) {
                          if (defaultNameNull) {
                            showCustomSnackBar('enter_restaurant_name'.tr);
                          } else if (restaurantRegiController.pickedLogo ==
                              null) {
                            showCustomSnackBar('select_restaurant_logo'.tr);
                          } else if (restaurantRegiController.pickedCover ==
                              null) {
                            showCustomSnackBar(
                                'select_restaurant_cover_photo'.tr);
                          } else if (defaultAddressNull) {
                            showCustomSnackBar('enter_restaurant_address'.tr);
                          } else if (restaurantRegiController
                                  .selectedZoneIndex ==
                              -1) {
                            showCustomSnackBar(
                                'please_select_zone_for_the_restaurant'.tr);
                          } else if (vat.isEmpty) {
                        ...
                        if ((restaurantRegiController.storeStatus == 0.6 &&
                      ...
                      data.addAll(RestaurantBodyModel(
                        deliveryTimeType:
                            restaurantRegiController.storeTimeUnit,
                        translation: jsonEncode(translation),
                        vat: vat,
                        minDeliveryTime: minTime,
                        maxDeliveryTime: maxTime,
                        lat: restaurantRegiController
                            .restaurantLocation!.latitude
                            .toString(),
                        email: email,
                        lng: restaurantRegiController
                        ...
                        zoneId: restaurantRegiController
                            .zoneList![
                                restaurantRegiController.selectedZoneIndex!]
                            .id
                            .toString(),
                        cuisineId: cuisines,
                        businessPlan:
                            restaurantRegiController.businessIndex == 0
                                ? 'commission'
                                : 'subscription',
                        packageId: restaurantRegiController.businessIndex == 0
                            ? ''
                            : restaurantRegiController
                                .packageModel!
                                .packages![restaurantRegiController
                      ...
                      restaurantRegiController
                          .registerRestaurant(data, additionalDocuments,
