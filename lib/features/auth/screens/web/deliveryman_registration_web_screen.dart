...
class _DeliverymanRegistrationWebScreenState
  ...
  void initState() {
    super.initState();
    _countryDialCode = _countryDialCode = CountryCode.fromCountryCode(
                            ...
                            child: Column(children: [
                              Row(children: [
                                  ...
                                  child: CustomDropdown<int>(
                                    ...
                                    child: Text(
                                      widget
                                          ...
                                          .tr,
                                      style: robotoRegular.copyWith(
                                          color: widget.deliverymanController
                                                      .dmTypeIndex ==
                                                  0
                                ...
                                const SizedBox(
                                    width:
                                        Dimensions.paddingSizeExtraOverLarge),
                                widget.deliverymanController.vehicleIds != null
                                    ? Expanded(
                                        child: Container(
                                          decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(
                              ...
                              Row(children: [
                                ...
                                Expanded(
                                  child: CustomTextFieldWidget(
                                    hintText: widget.deliverymanController
                                                .identityTypeIndex ==
                                            0
                                        ? 'Ex: XXXXX-XXXXXXX-X'
                                        : 'L-XXX-XXX-XXX-XXX.',
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(
                                left: Dimensions.paddingSizeLarge),
                            child: TramsConditionsCheckBoxWidget(
                          ...
                          Padding(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      width: 165, child: widget.buttonView),
                                ]),
                          ),
                        ]),
                      ),
