...
import 'package:zaika/features/auth/domain/models/delivery_man_body_model.dart';
import 'package:zaika/features/auth/widgets/trams_conditions_check_box_widget.dart';
...
import 'package:zaika/features/auth/screens/web/deliveryman_registration_web_screen.dart';
import 'package:zaika/features/auth/widgets/deliveryman_additional_data_section_widget.dart';
...
class _DeliveryManRegistrationScreenState
  ...
  void initState() {
    ...
    Get.find<DeliverymanRegistrationController>()
        .dmStatusChange(0.1, isUpdate: false);
    Get.find<DeliverymanRegistrationController>()
                                          ...
                                          child: Form(
                                            ...
                                            child: Column(children: [
                                              Row(children: [
                                                ...
                                                CustomToolTip(
                                                  message:
                                                      'this_info_will_need_for_delivery_app_login'
                                                          .tr,
                                                  tooltipController:
                                                      tooltipController,
                                                ),
                                                              ...
                                                              children: [
                                                                ClipRRect(
                                                                  ...
                                                                  child: deliverymanController
                                                                      ...
                                                                      ? GetPlatform
                                                                          ...
                                                                          ? Image
                                                                              .network(
                                                                              deliverymanController.pickedImage!.path,
                                                                              width: 150,
                                                                              height: 140,
                                                                              fit: BoxFit.cover,
                                                                            )
                                                                          : Image
                                                                              .file(
                                                                              File(deliverymanController.pickedImage!.path),
                                                                              width: 150,
                                                                              height: 140,
                                                                              fit: BoxFit.cover,
                                                                            )
                                                                ...
                                                                Positioned(
                                                                  ...
                                                                  child:
                                                                      InkWell(
                                                                    onTap: () =>
                                                                        deliverymanController.pickDmImage(
                                                                            true,
                                                                            false),
                                                                    child:
                                                                        DottedBorder(
                                                                ...
                                                                deliverymanController
                                                                    ...
                                                                    ? Positioned(
                                                                        ...
                                                                        child:
                                                                            InkWell(
                                                                          onTap: () =>
                                                                              deliverymanController.removeDmImage(),
                                                                          child:
                                                                              Container(
                                                                            decoration:
                                                                                BoxDecoration(
                                                  ...
                                                  CustomTextFieldWidget(
                                                    ...
                                                    validator: (value) =>
                                                        ValidateCheck
                                                            .validateEmptyText(
                                                                value,
                                                                "enter_password_for_delivery_man"
                                                                    .tr),
                                                  ),
                                                  deliverymanController
                                                          .showPassView
                                                              ...
                                                              Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child: Text(
                                                                    deliverymanController
                                                                        .vehicles![
                                                                            deliverymanController.vehicleIndex!]
                                                                        .type!
                                                                        .tr,
                                                                    style: robotoRegular.copyWith(
                                                                        color: Theme.of(context)
                                                    ...
                                                    CustomTextFieldWidget(
                                                      ...
                                                      isEnabled:
                                                          deliverymanController
                                                                  .identityTypeIndex !=
                                                              0,
                                                      fromDeliveryRegistration:
                                                          true,
                                                      validator: (value) =>
                                                          ValidateCheck
                                                              .validateEmptyText(
                                                                  value,
                                                                  "identity_number_field_is_required"
                                                                      .tr),
                                                    ),
                                                    const SizedBox(
                                                        height: Dimensions
    ...
    return GetBuilder<DeliverymanRegistrationController>(
      ...
      return Container(
        ...
        child: CustomButtonWidget(
          ...
          buttonText: (deliverymanController.dmStatus == 0.1 &&
                  !ResponsiveHelper.isDesktop(context))
              ? 'next'.tr
              : 'submit'.tr,
